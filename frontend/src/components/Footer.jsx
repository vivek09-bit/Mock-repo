...
<footer className="footer">
  ...
  <div className="bg-dark py-5 py-xl-8 py-xxl-9 border-top border-light">
    <div className="container overflow-hidden">
      <div className="row gy-md-0 align-items-md-center">
        <div className=" order-1 order-md-0">
          <div className="copyright  text-md-start">
            &copy; 2024. All Rights Reserved.
          </div>
          <div className="credits text-secondary text-md-start mt-2 fs-8">
            Built by <a href="http://localhost:5173/" className="link-secondary text-decoration-none">Team Ignite</a> with <span className="text-primary">&#9829;</span>
          </div>
        </div>
